...
import { Menu, Home, User, BookOpen, LogOut, GraduationCap, Globe } from 'lucide-react';
...
const StudentToolbar: React.FC<StudentToolbarProps> = ({ title, subtitle, rightContent }) => {
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                <DropdownMenuItem onClick={handleNavigateToDashboard}>
                  ...
                  <span className="text-base">Về trang quản lý</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleNavigateToCourses}>
                  <BookOpen className="mr-3 h-5 w-5" />
                  <span className="text-base">Xem các lớp của tôi</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleNavigateToProfile}>
                  <User className="mr-3 h-5 w-5" />
                  <span className="text-base">Xem hồ sơ</span>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={handleNavigateToHome}>
